...
% \vspace{-12pt}
% \centerline{\includegraphics[height=5.5cm]{Logo/EEEIC_logo.jpg}
% \end{minipage}
...
\addtobeamertemplate{frametitle}{}{%
\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north east] at (current page.north east) {\includegraphics[height=1.5cm]{Logo/unitn.png}};
\end{tikzpicture}
}
